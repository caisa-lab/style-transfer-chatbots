#!/bin/sh
#SBATCH --job-name=finetune_roberta_olid
#SBATCH --output="/ukp-storage-1/nothvogel/gyafc-classifier/logs/log_olid.txt"
...
# Experiment Details :- RoBERTa model for olid.
# Run Details :- none
...
DATA_DIR="/ukp-storage-1/nothvogel/style-dataset-preprocessing/data/olid/classification"

# replace olid with name of dataset!
