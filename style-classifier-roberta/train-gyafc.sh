#!/bin/bash
#SBATCH --job-name=finetune_roberta_gyafc
#SBATCH --output="/ukp-storage-1/nothvogel/gyafc-classifier/logs/log_gyafc.txt"
...
# Experiment Details :- RoBERTa model for gyafc.
# Run Details :- none
...
DATA_DIR="/ukp-storage-1/nothvogel/style-dataset-preprocessing/data/gyafc"
