#!/bin/sh
#SBATCH --job-name=finetune_pegasus_debate_sum_large
#SBATCH --output="/ukp-storage-1/nothvogel/summary-pegasus/logs/log_debate_sum_large.txt"
...
OUT_DIR="results/debate-sum_large"
TRAIN_BATCH_SIZE=8
EVAL_BATCH_SIZE=16
