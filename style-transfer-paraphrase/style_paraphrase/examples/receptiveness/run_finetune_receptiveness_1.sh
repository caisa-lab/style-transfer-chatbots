#!/bin/sh
#SBATCH --job-name=finetune_gpt2_receptiveness_1
#SBATCH --output="/ukp-storage-1/nothvogel/style-transfer-paraphrase/style_paraphrase/logs/log_receptiveness_1.txt"
...
python3 $BASE_DIR/run_lm_finetuning.py \
    --output_dir=$BASE_DIR/saved_models/model_receptiveness_1 \
    --model_type=gpt2 \
